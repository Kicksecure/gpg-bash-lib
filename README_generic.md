...
NOTE: Replace `generic-package` with the actual name of this package `gpg-bash-lib`.
...
`gpg-bash-lib` requires [donations](https://www.kicksecure.com/wiki/Donate) to stay alive!
